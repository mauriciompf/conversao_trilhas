...
function toggleMenu() {
    var _a;
    (_a = document.querySelector("#sidebar")) === null || _a === void 0 ? void 0 : _a.classList.toggle("show");
}
...
function popupLivroDigital() {
    ...
    if (!((_a = materialMenu) === null || _a === void 0 ? void 0 : _a.classList.contains(`estagio`))) {
        if (refDigital) {
            if (seenPopupChegouLivro == null || seenPopupChegouLivro === "") {
                ...
                (_c = (_b = styleItem) === null || _b === void 0 ? void 0 : _b.parentNode) === null || _c === void 0 ? void 0 : _c.insertBefore(popstyle, styleItem);
                let popupHTML = '<div class="popup-material" onclick="closepop()"><div class="popup-balao" onclick="event.stopPropagation()"><p>Acadêmico, o novo <b>Livro Digital</b> já está disponível para esta disciplina. Não deixe de acessar!</p><p>Estamos sempre trabalhando para trazer novos materiais para você. 😄</p><button onclick="closepop()"> Fechar</button></div></div>';
            ...
            let materialMenu = document.querySelector(`#material-menu`);
            let linkLivro = (_d = document.querySelector(`#material-menu-livro`)) === null || _d === void 0 ? void 0 : _d.href;
            (_e = materialMenu) === null || _e === void 0 ? void 0 : _e.insertAdjacentHTML(`afterbegin`, `	<a  id="material-menu-livro-digital" 
...
function openLivroWarning() {
    var _a;
    (_a = document.querySelector(`.popup-livro-warning`)) === null || _a === void 0 ? void 0 : _a.classList.add(`visible`);
}
function closeLivroWarning() {
    var _a;
    (_a = document.querySelector(`.popup-livro-warning`)) === null || _a === void 0 ? void 0 : _a.classList.remove(`visible`);
}
...
function tabify() {
    document
        .querySelectorAll(".top-unidade, .subheader, .header, .content-text p, .content-text span, .content-text img, .text-large, .button-next, .content-unidade,  .ex-enun, .ex-alts")
        .forEach((el) => {
        el.setAttribute("tabindex", "0");
    });
    document
        .querySelectorAll(".menu-side-item, .accessibility-item, .objeto *, .dica-leitura > img, .material-icons")
        .forEach((el) => {
...
function hideMenuIfCookie() {
    ...
    if (getCookie("side-menu-visibility") === "visible") {
        try {
            (_a = document.querySelector("#material-menu")) === null || _a === void 0 ? void 0 : _a.classList.remove("hidden");
        }
        catch (e) { }
    }
}
...
class Popper {
    static createPopper(parent, hint, options) { }
    destroy() { }
}
...
function showPopper(element) {
    ...
    hint.setAttribute(`data-placement`, elementPosition.top < 330 ? "bottom" : "top");
    let pageWidth = document.body.getBoundingClientRect().width;
    let hintXOffset = pageWidth - 280 - elementPosition.left;
    if (hintXOffset < 0) {
        hint.style.transform = `translateX(${hintXOffset - 60}px)`;
    }
...
function initPops() {
    ...
    if (capsulas.length > 0) {
        let putBefore = document.getElementsByTagName("script")[0];
        let popperLib = document.createElement("script");
        popperLib.src = "../js/popper.min.js";
        putBefore.parentNode.insertBefore(popperLib, putBefore);
        capsulas.forEach((el) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (explain != undefined && explain != ``) {
				...
				<div class="hint">
					...
					<p>
						<a  href="https://pt.wikipedia.org/wiki/${keywords}" 
							target="_blank">
								Ler Mais
